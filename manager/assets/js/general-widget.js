...
const salesStatsChartsEl = new ApexCharts(
  document.querySelector("#salesStatsRadialCharts"),
  salesStatsOption
);
...
var UserActivity = new ApexCharts(
  document.querySelector("#UserActivity"),
  options
);
UserActivity.render();
...
var chart = new ApexCharts(
  document.querySelector("#latestSales-chart"),
  options
);
chart.render();
